...
@user_router.put("/user_update/{user_id}", response_model=UserUpdate, operation_id="user_update")
...
@user_router.put("/user_delete/{user_id}", status_code=HTTPStatus.NO_CONTENT, operation_id="user_delete")
